...
namespace WebMypham.Areas.Admin.Controllers
{
    public class NhacungcapsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "NhacungcapID,TenNCC,Diachi,Email,SDT,Fax")] Nhacungcap nhacungcap)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "NhacungcapID,TenNCC,Diachi,Email,SDT,Fax")] Nhacungcap nhacungcap)
        {
            if (ModelState.IsValid)
            {
